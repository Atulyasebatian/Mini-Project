...
function ReportPage() {
  ...
  // NEW: State for vehicles instead of routes
  const [vehicles, setVehicles] = useState([]);
  // NEW: State for the selected vehicle's ID
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // UPDATED: Check for selectedVehicle instead of selectedRoute
    ...
    try {
      const token = localStorage.getItem("token");
      // UPDATED: Send vehicleId to the backend
